...
public class Util {
    ...
    public void sendHelp(MessageChannel channel) {
        String helpMessage = "```Marko Rov Help!\n"
            ...
            + "!markov @User  --  Return phrase based on target user if they have opted in (max: 140)\n"
            + "!markov @User 120  --  Return phrase based on target user if they have opted in (max length: 1500)\n"
